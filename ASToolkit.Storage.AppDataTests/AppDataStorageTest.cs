...
public class AppDataStorageTest : IAsyncLifetime
{
    ...
    public void GetFilesInDirectory_DirectoryExists_ReturnsFiles(IStorage fileStorageProvider)
    {
        ...
        Assert.Contains(Path.Combine(ApplicationName, directoryPath, "file1.txt"), files);
        Assert.Contains(Path.Combine(ApplicationName, directoryPath, "file2.txt"), files);
    }
        ...
        IStorage fileStorageProvider)
    {
        ...
        Assert.Contains(Path.Combine(ApplicationName, directoryPath, "subDir1"), directories);
        Assert.Contains(Path.Combine(ApplicationName, directoryPath, "subDir2"), directories);
    }
